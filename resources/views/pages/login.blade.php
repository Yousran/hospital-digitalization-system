                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('login') }}" method="POST">
                        ...
                        <button type="button"
                            ...
                            <svg class="w-5 h-5 mr-2" aria-hidden="true" focusable="false" data-prefix="fab"
                                data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
                                <path fill="currentColor"
                                    d="M488 261.8c0-17.7-1.6-35.2-4.7-52H249v98.4h134.6c-8.2 41.9-33.1 77.4-70.6 101.5v83.6h113.7c66.4-61.2 104.3-151.4 104.3-231.5zM249 512c67.2 0 123.6-22.4 164.8-60.7l-113.7-83.6c-20.8 14-47.3 22.4-76.4 22.4-58.8 0-108.6-39.8-126.4-93.2H9.2v85.2C44.6 454.6 141.1 512 249 512zM122.6 306.9c-5.2-15.5-8.1-32.1-8.1-49s2.9-33.5 8.1-49v-85.2H9.2C-6.7 206.5-14 247.5-14 289.8s7.3 83.3 23.2 116.2l113.7-83.6zM249 114.6c29.1 0 55.6 10.1 76.4 22.4l113.7-83.6C372.6 22.4 316.2 0 249 0 141.1 0 44.6 57.4 9.2 127.8l113.7 83.6c17.8-53.4 67.6-93.2 126.4-93.2z">
                                </path>
                            </svg>
                            Login with Google
                        </button>
