...
@section('contents')
    <x-form formMethod="POST" action="{{ route('biographs.update', $patient->biograph->id) }}" routeBack="{{ route('patients.index') }}" xlColSpan="2" mdColSpan="2" formHeading="Edit Patient">
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="name" id="name"
                ...
                placeholder="Username" value="{{ $patient->user->name ?? '' }}">
            @error('name')
