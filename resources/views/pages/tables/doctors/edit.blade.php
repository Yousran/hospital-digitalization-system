...
@section('contents')
<x-form formMethod="POST" action="{{ route('biographs.update', $doctor->biograph->id) }}" routeBack="{{ route('doctors.index') }}" xlColSpan="2" mdColSpan="2" formHeading="Edit Doctor">
    ...
    <div>
        ...
        <input type="text" name="name" id="name"
            ...
            placeholder="Username" value="{{ $doctor->user->name ?? '' }}">
        @error('name')
