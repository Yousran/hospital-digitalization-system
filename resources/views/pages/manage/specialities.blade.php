...
@section('title', 'Doctor Specialities')
        ...
        <div class="col-span-1 sm:col-span-3">
            <x-profile-card dropdownId="2" id="modal-container">
                <div class="items-center p-4 w-full">
                    <x-datatable routeDelete="specialities.destroy" dataName="Doctor Specialities" routeEdit="specialities.edit" routeDatatable="specialities.datatable"></x-datatable>
                </div>
                <x-modal target="createModal" modalTitle="Create Doctor Speciality">
