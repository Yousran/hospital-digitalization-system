        ...
        <div class="col-span-1 sm:col-span-3">
            <x-profile-card dropdownId="2" id="modal-container">
                <div class="items-center p-4 w-full">
                    <x-datatable routeDelete="patients.destroy" dataName="Patients" routeEdit="patients.edit" routeDatatable="patients.datatable"></x-datatable>
                </div>
                <x-modal target="createModal" modalTitle="Create Patient">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="relatives" class="mt-1 block w-full p-2 border rounded-lg">
                                    </div>
                                </div>
